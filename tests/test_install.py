...
'''
    ...
    def test_qqq_fresh_install_preserves_saved_mode_and_reuses_unchanged_deployment(self):
        ...
        self.assertEqual(spec['output_dir'], str(self.state / 'qqq-hedge-scalper-v2'))
        self.assertEqual(spec['scalper']['model'], 'perp_dex_scalper_v2')
    ...
    def test_qqq_default_nine_upgrade_starts_three_without_rewriting_history(self):
        ...
        self.assertEqual(path.with_name('qqq-hedge.before-scalper-v2.json').read_bytes(), old_bytes)
    ...
    def test_qqq_current_three_upgrade_preserves_ledgers_and_then_skips_unchanged(self):
        ...
        new = json.loads(path.read_text())
        self.assertEqual(new['previous_output_dir'], str(old_output))
        self.assertEqual(new['scalper']['model'], 'perp_dex_scalper_v2')
        self.assertEqual(path.with_name('qqq-hedge.before-scalper-v2.json').read_bytes(), original)
